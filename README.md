...
[![tests](https://github.com/ddev/ddev-milvus/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/ddev/ddev-milvus/actions/workflows/tests.yml?query=branch%3Amain)
[![last commit](https://img.shields.io/github/last-commit/ddev/ddev-milvus)](https://github.com/ddev/ddev-milvus/commits)
[![release](https://img.shields.io/github/v/release/ddev/ddev-milvus)](https://github.com/ddev/ddev-milvus/releases/latest)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.milvus.yaml](docker-compose.milvus.yaml) file.
...
3. Globally replace "milvus" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.milvus.yaml` with the `docker-compose.*.yaml` for your recipe.
